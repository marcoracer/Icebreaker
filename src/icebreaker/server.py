...
def create_mcp_server(config: IcebreakerConfig) -> FastMCP:
    ...
    server = FastMCP(
        name="icebreaker-mcp",
        description="Intelligent Snowflake MCP Agent specialized in DataOps and Administration"
    )

    # TODO: Add tools as they are implemented
    # Tier 1: Discovery tools will be added first
    # server.add_tool(list_databases)
    # server.add_tool(list_schemas)
    # etc.
